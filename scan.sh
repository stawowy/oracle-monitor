...
/usr/local/nagios/libexec/check_oracle_health --connect=$(cat IP_ADDRESS.txt):1521/$(cat ORACLE_SID.txt) --username=nagios --password=nagios --mode list-sysstats >> /home/reports/report.txt